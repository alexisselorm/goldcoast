                    ...
                    <a class="relative block bg-white border-t-orange-600 h-full" href="#">
                        ...
                        <div class="p-[20px] pb-[60px] relative">
                            <div class="overflow-hidden pb-[3px]">
                                ...
                                <h3 class="text-[1em] leading-[1.67em] font-[600] inline ">{{strtoupper($single_news->title) }}</h3>
                                <span class="absolute left-[20px] bottom-0 text-[.67em] leading-[1.67em]">{{$single_news->created_at->diffForHumans()}}</span>
                                <br>
                            </div>
                        </div>
                    </a>
